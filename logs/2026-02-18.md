...
## [[conductor-build]] - Parallel Coding Agents on Mac

Mac app by Melty Labs for running parallel Claude Code and Codex agents in isolated git worktrees. See what every agent is working on, then review and merge. Trusted by Linear, Vercel, Notion, Stripe teams. Simple, dev-oriented site with a standout pixel/dot-matrix logo — added to [[index-curated-sites]].
